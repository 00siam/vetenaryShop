  ...
  return (
    <>
      ...
      <Card style={{ padding:30, marginRight: 30}}>
        <Card.Img variant="top" src="https://jaldeevets.com/wp-content/uploads/2023/02/Jaldee-Vets-Blog-Banners-43-768x512.png" />
        <Card.Body>
          <Card.Title style={{color:"orange"}}> <b>Heartbreaking Incidents Of Animal Cruelty In India</b></Card.Title>
          <Card.Text className="text-justify">
           India is famous for having a considerable number of street animals. While humans should be more sensitive to stray animals, it is quite the opposite in India. The homeless animals, apart from their struggles in life, have to suffer at the hands of humans. Many unsettling incidents of animal cruelty question humanity amongst humans. 
      ...
      {/* Second block  */}
      <Card style={{ padding:30, marginRight: 30}}>
        <Card.Img variant="top" src="https://jaldeevets.com/wp-content/uploads/2023/02/Jaldee-Vets-Blog-Banners-40-768x512.png" />
        <Card.Body>
          <Card.Title style={{color:"orange"}}> <b>5 Reasons Why Rabbits Make Great Pets</b></Card.Title>
          <Card.Text>
      ...
      {/* Third block  */}
      <Card  style={{ padding:30, marginRight: 30 }}>
        <Card.Img variant="top" src="https://jaldeevets.com/wp-content/uploads/2023/02/Jaldee-Vets-Blog-Banners-39-768x512.png" />
        <Card.Body>
          <Card.Title style={{color:"orange"}}> <b>5 Simple Foods That Can Be Poisonous For Dogs</b></Card.Title>
          <Card.Text>
